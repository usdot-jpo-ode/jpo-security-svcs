...
----------------------------------------
### **Summary**
The changes for the jpo-security-svcs v1.7.0 release include adding a workflow for external issues notification and migrating to reusable Docker workflows. No changes were made to the functionality of the service.
